...
setMethod("mi.sigma", signature(object = "mi.mixed"),     
  function ( object ) {
    return( object$model$model.2$sigma )
  }
)

setMethod("mi.expected", signature(object = "mi.mixed"),     
  function ( object ) {
   return( object$expected )
  }
)

setMethod("mi.resid", signature(object = "mi.mixed"),     
  function ( object, Y ) {
   return( list(residual.values.1=1*(Y>0)-mi.expected(object)[[1]], 
                residual.values.2=Y[as.double(names(mi.expected(object)[[2]]))]-mi.expected(object)[[2]]) )
  }
)

setMethod("mi.imputed", signature(object = "mi.mixed"),     
  function ( object, Y ) {
